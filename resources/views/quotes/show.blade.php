                    ...
                    <paper-card image="{{ $graphic->path() }}">
                      ...
                      <div class="card-actions">
                        <div class="horizontal justified">
                            ...
                            <a href="https://www.pinterest.com/pin/create/button/?url=https://tipoff.com/{{ $quote->author->path() }}&media={{ $graphic->path() }}&description=Business%20and%20Leadership%20Quotes%20from%20{{ $urlauthorname }}" data-pin-do="buttonPin" data-pin-custom="true"><img src="/img/pinterest.png"></img></a>
                        </div>
                      </div>
                    </paper-card>
                @endforeach
