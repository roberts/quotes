                    ...
                    <paper-card image="{{ $graphic->path() }}">
                      ...
                      <div class="card-actions">
                        <div class="horizontal justified">
                            ...
                            <a href="https://www.pinterest.com/pin/create/button/?url=https://tipoff.com/{{ $quote->author->path() }}&media={{ $graphic->path() }}&description=View%20more%20Business%20and%20Leadership%20Quotes%20from%20{{ $urlauthorname }}" data-pin-do="buttonPin"><paper-icon-button src="/img/pinterst.png"></paper-icon-button></a>
                        </div>
                      </div>
                    </paper-card>
                @endforeach
